 ...
 *
 */
public class ProjectsSubscribedFragment extends Fragment {
    @Override
                ...
                new Api.ApiListener() {
                    ...
                    public void onResponse(String json) {
                        try {
                            ...
                            for (int i = 0; i < projects.listProject.size();) {
                                if (!projects.listProject.get(i).isRegistered)
                                    projects.listProject.remove(i);
                                else
                                    i++;
                            }
